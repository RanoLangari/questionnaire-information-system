        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown active" data-bs-toggle="dropdown"><i class="fas fa-book-open"></i>Kuisioner</a>
                        <div class="dropdown-menu">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" style="margin-top: 20px;">
                        Tambah Data
                    </button>
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#EditModal" style="margin-top: 20px; margin-left: 20px;">
                        Ubah Data
                    </button>
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#HapusModal" style="margin-top: 20px; margin-left: 20px;">
                        Hapus Data
                    </button>
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3"><label class="form-label" for="pilihan_jawaban"><strong>Pilihan Jawaban</strong></label><input class="form-control" type="text" id="pilihan_jawaban" name="pilihan_jawaban">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3"><label class="form-label" for="OpsiLama"><strong>Opsi Jawaban Lama</strong></label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3"><label class="form-label" for="OpsiBaru"><strong>Opsi Jawaban Baru</strong></label><input class="form-control" type="text" id="OpsiBaru" name="OpsiBaru">
                                    </div>
                                </div>
                            </div>
                        </div>
