                                    ...
                                    <tbody>
                                        ...
                                        foreach ($user as $rows) : ?>
                                            <tr>
                                                ...
                                                <td><?= $rows["tipe"] ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?= $rows["id_pertanyaan"] ?>">Edit</button>
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?= $rows["id_pertanyaan"] ?>">Hapus</button>
                                                    ...
                                                    <div class="modal-content">
                                                        <form method="post" action="">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="UbahPertanyaan" style="border-radius: 0;">Ubah</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn btn-danger" name="HapusPertanyaan" style="border-radius: 0;">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
